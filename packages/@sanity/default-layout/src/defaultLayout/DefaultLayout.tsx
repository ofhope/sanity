...
import {Root, MainArea, ToolContainer, SidecarContainer} from './styles'
...
export const DefaultLayout = withRouterHOC((props: Props) => {
  ...
  useEffect(() => {
    userStore.me.subscribe((u: User) => setUser(u))
  }, [])
    ...
    return (
      <Root $isOverlayVisible={isOverlayVisible}>
        ...
        <MainArea $isOverlayVisible={isOverlayVisible}>
          ...
          <Box flex={1} ref={setPortalElement} style={{position: 'absolute', inset: 0}} />
        </MainArea>
